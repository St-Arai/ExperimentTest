...
public final class Color implements ConfigurationSerializable {
	...
	/**
	 * Creates a new color object from an integer that contains the red, green, and blue bytes in
	 * the lowest order 24 bits.
	 * 
	 * @param rgb
	...
	/**
	 * Creates a new color object from an integer that contains the blue, green, and red bytes in
	 * the lowest order 24 bits.
	 * 
	 * @param bgr
	...
	public Map<String, Object> serialize() {
		return ImmutableMap.<String, Object> of("RED", getRed(), "BLUE", getBlue(), "GREEN",
				getGreen());
	}
