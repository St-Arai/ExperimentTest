...
public class ConversationAbandonedEvent extends EventObject {
	...
	/**
	 * Indicates how the conversation was abandoned - naturally as part of the prompt chain or
	 * prematurely via a {@link ConversationCanceller}.
	 * 
	 * @return True if the conversation is abandoned gracefully by a {@link Prompt} returning null
	 *         or the next prompt. False of the conversations is abandoned prematurely by a
